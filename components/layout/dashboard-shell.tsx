        ...
        <header className="sticky top-0 z-20 border-b border-white/70 bg-white/72 backdrop-blur-xl">
          <div className="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500">لوحة تشغيل عربية لإدارة الأداء التعليمي والملفات المدرسية</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <Button variant="ghost" size="icon" className="rounded-2xl lg:hidden" onClick={() => setOpen((value) => !value)}>
      ...
      <div className="space-y-6">
        <div
          className={cn(
            ...
            mobile
              ? "border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f7fafb_100%)]"
              : "border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.11)_0%,rgba(255,255,255,0.04)_100%)] shadow-panel",
          )}
        >
          <p className={cn("text-sm font-semibold", mobile ? "text-primary" : "text-[#d6e8ef]")}>الملاحة الرئيسية</p>
